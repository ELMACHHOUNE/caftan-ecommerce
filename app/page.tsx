  ...
  const features = [
    {
      ...
      description: "Each caftan is meticulously crafted by skilled Moroccan artisans",
    },
    {
      icon: Package,
      title: "Rent or Buy",
      description: "Flexible options to rent for special occasions or purchase forever",
    },
    {
      icon: Clock,
      title: "Fast Delivery",
      description: "Express shipping available throughout Morocco and internationally",
    },
    {
      icon: Shield,
      ...
      <main className="flex-1">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products?type=rent">
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 h-14">
                  Rent a Caftan
                </Button>
              </Link>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-primary">Featured Collection</h2>
              <p className="text-xl text-muted-foreground">Discover our most beloved pieces</p>
            </div>
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-balance">Experience Moroccan Craftsmanship</h2>
            <p className="text-xl leading-relaxed opacity-90">
              Each caftan tells a story of tradition, artistry, and timeless elegance passed down through generations
            </p>
            <Link href="/about">
