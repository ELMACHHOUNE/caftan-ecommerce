...
import { LayoutDashboard, Package, Users, ShoppingCart, Settings, ChevronLeft } from "lucide-react"
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="h-20 flex items-center justify-between px-6 border-b border-sidebar-border">
          {!collapsed && <h2 className="text-xl font-bold text-sidebar-foreground">Admin Panel</h2>}
          <Button
            variant="ghost"
            size="icon"
